...
const App: React.FC = () => {
  ...
  const handleLogout = () => {
    setState(prev => ({ 
      ...prev, 
      user: { id: 'local-user', email: 'local@zenbudget.app', name: 'Utilisateur Zen' } 
    }));
  };
        ...
        <div className="h-full w-full">
          ...
          {activeView === 'SETTINGS' && (
            <Settings 
              ...
              onReset={handleReset} onLogout={handleLogout} onLogin={handleLogin} onShowWelcome={() => setShowWelcome(true)} 
              onBackup={() => {
