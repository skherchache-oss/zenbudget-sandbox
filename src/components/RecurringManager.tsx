        ...
        {isAdding && (
          ...
          >
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => { setIsAdding(false); setEditingId(null); }} className="text-slate-400 p-2"><X className="w-5 h-5" /></button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative">
                  <select
                    className="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-indigo-500 transition-all appearance-none"
            ...
            .map(t => {
              ...
              return (
                <motion.div
                  layout
                  key={t.id}
                  className="bg-white p-5 rounded-[30px] border border-slate-50 shadow-sm group hover:shadow-md transition-all"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          <div className={`font-black text-base ${t.type === 'INCOME' ? 'text-emerald-500' : 'text-slate-900'}`}>
